  ...
  return (
    <div className='w-[85%] mx-auto md:ml-[35%] md:w-[50%]'>
            <div className='flex justify-between my-4'>
                <input ref={titleRef} placeholder='Enter new task' className='w-[78%] rounded-md outline-none p-1 font-sans' type="text" />
            ...
            <div className='flex justify-between' >
                <input ref={dateRef} type="date" name="" id="" className='rounded-md w-[20%] px-1'/>
                <div onClick={addNewTodo} className='w-[78%] cursor-pointer text-center bg-yellow-500 rounded-md p-1'>Add New</div>
            </div>
        </div>
  )
}
