...
const LandingPage = () => {
  ...
  return (<div className='w-full font-poppins text-white '>
    ...
    {/* FloatingIcons */}
    <div ref={ref1} className='bg-yellow-500 w-20 h-20 absolute rounded-full sm:top-[20%] sm:left-[10%] blur-md top-[10%] left-[70%] sm:block'></div>
    <div ref={ref2} className='bg-yellow-500 w-20 h-20 absolute rounded-lg rotate-45 top-[55%] left-[15%] blur-md hidden sm:block'></div>
    ...
    <div ref={ref4} className='bg-yellow-500 w-20 h-20 absolute rounded-full sm:top-[50%] sm:left-[78%] blur-md top-[50%] left-[10%] sm:block'></div>
    {/* Lower Section */}
